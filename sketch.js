...
var obstaclesGroup, obstacle1, obstacle2,obstacle3,obstacle4,obtacle5,obstacle6;
...
function preload(){
  ...
  // imagem do chão 
  cloudImage = loadImage("cloud.png"); // imagem da nuvem
...
function draw() {
 ...
 score=score+ Math.round (fremeCount/60);
